function [sigbins, p_adj, p_values] =  fdr_bhtest2_nonparam(varargin)
...
%Compute non-param test
[linear_sigbins, linear_p_adj, linear_p_values] = fdr_bhtest_nonparam(g1_redim, g2_redim,  FDR,...
    paired, ploton);
...
fdr_bhtest2_nonparam(group1,group2, 'paired', false);
